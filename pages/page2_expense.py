...
expense_df_test = df[df['transaction_type'] == 'Expense']
st.write(expense_df_test)
...
show_top_5_categories_donut_chart(expense_transactions, selected_year_time_series, 'Expense')
