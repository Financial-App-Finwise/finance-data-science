...
pre.category_df = pre.get_df(api_config.categories_api_url, api_config.token)
pre.transaction_df = pre.convert_json_to_df(api_config.transaction_api_url, api_config.token)
pre.goal_api_df = pre.convert_json_to_df(api_config.goal_api_url, api_config.token)
